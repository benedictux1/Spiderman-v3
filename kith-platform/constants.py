...
class Categories:
    ...
    ENVIRONMENT_AND_LIFESTYLE = "Environment and lifestyle"
    PSYCHOLOGY_AND_VALUES = "Psychology and values"
    COMMUNICATION_STYLE = "Communication style"
    CHALLENGES_AND_DEVELOPMENT = "Challenges and development"
    ADMIN_MATTERS = "Admin matters"
    DEEPER_INSIGHTS = "Deeper insights"
